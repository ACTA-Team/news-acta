  ...
  return (
    <LegalDocPage title="Terms of Service" lastUpdated={LEGAL_LAST_UPDATED}>
      ...
      <p>
        ...
        carefully and, where appropriate, to obtain independent legal advice. Nothing here creates a
      ...
      <h2>3. Eligibility</h2>
      <p>
        You may use the Services only if you can form a binding contract with ACTA under applicable
        law. If you use the Services on behalf of an organization, you represent that you have
        authority to bind that organization, and &ldquo;you&rdquo; includes the organization. You
        must not use the Services if you are prohibited from doing so by applicable sanctions,
        export, or other laws.
      </p>

      <h2>4. Accounts and access</h2>
      <p>
        Certain features may require an account. You are responsible for maintaining the
        confidentiality of your credentials, for all activity under your account, and for providing
        accurate information. You must notify us promptly of any unauthorized use. We may suspend or
        terminate access if we reasonably believe you have violated these Terms, pose a security
        risk, or if required by law. Authentication flows (including social sign-in) may be provided
        by third parties; their use is also subject to their terms and policies.
      </p>
      ...
      <ul>
        ...
        <li>
          Use the Services to build a competing product or to reverse engineer the Services, except
          where such restriction is unenforceable under applicable law
        </li>
      </ul>
      ...
      <h3>Your content</h3>
      <p>
        If you submit content to us (e.g. comments, contributions, or materials for publication),
        you grant ACTA a worldwide, non-exclusive, royalty-free license to use, host, reproduce,
        modify, display, and distribute such content for the purpose of operating, promoting, and
        improving the Services. You represent that you have the rights to grant this license. You
        retain ownership of your content subject to the license above.
      </p>

      <h2>7. Third-party links and services</h2>
      <p>
        The Services may link to or integrate third-party sites, services, or content. We do not
        control and are not responsible for third parties. Your use of third-party services is at
        your own risk and subject to their terms and privacy practices.
      </p>
      ...
      <p>
        TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL ACTA, ITS AFFILIATES,
        ...
        OPPORTUNITY, ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICES, WHETHER IN CONTRACT,
      ...
      <p>
        ...
        without regard to conflict of law rules. The United Nations Convention on Contracts for the
      ...
      <p>
        ...
        and ACTA regarding the Services. If a provision is held invalid, the remainder remains in
        effect. Our failure to enforce a right is not a waiver. You may not assign these Terms
        without our consent; we may assign them in connection with a merger, acquisition, or sale of
        assets. Section headings are for convenience only.
      </p>

      <h2>13. Contact</h2>
      <p>
        For questions about these Terms, contact us through the channels provided on our website at{' '}
