/**
 * Activity-scanner helpers: pull operations for a monitored account from
 * Horizon and classify them into activity_events. Used by the
 * `activity_scanner` edge function.
 */
